...
// [PEEEEK] Variables
MACRO_CONFIG_INT(ClPeeeekKogMode, cl_peeeek_kog_mode, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Kog Mode (Auto-hammer)")
MACRO_CONFIG_INT(ClPeeeekTargetEsp, cl_peeeek_target_esp, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Target ESP")
MACRO_CONFIG_INT(ClPeeeekTargetEspSize, cl_peeeek_target_esp_size, 100, 10, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Target ESP Size")
MACRO_CONFIG_COL(ClPeeeekTargetEspColor, cl_peeeek_target_esp_color, 0xFFFFFFFFU, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Target ESP Color")

MACRO_CONFIG_INT(ClPeeeekHitParticles, cl_peeeek_hit_particles, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Hit Particles")
MACRO_CONFIG_INT(ClPeeeekHitParticlesCount, cl_peeeek_hit_particles_count, 10, 1, 30, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hit Particles Count")
MACRO_CONFIG_INT(ClPeeeekHitParticlesSize, cl_peeeek_hit_particles_size, 15, 5, 50, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hit Particles Size")
MACRO_CONFIG_INT(ClPeeeekHitParticlesTexture, cl_peeeek_hit_particles_texture, 1, 1, 13, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hit Particles Texture ID")
MACRO_CONFIG_COL(ClPeeeekHitParticlesColor, cl_peeeek_hit_particles_color, 0xFFFFFFFFU, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hit Particles Color")

MACRO_CONFIG_INT(ClPeeeekWorldParticles, cl_peeeek_world_particles, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable World Particles")
MACRO_CONFIG_INT(ClPeeeekWorldParticlesCount, cl_peeeek_world_particles_count, 20, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Count")
MACRO_CONFIG_INT(ClPeeeekWorldParticlesSize, cl_peeeek_world_particles_size, 10, 5, 50, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Size")
MACRO_CONFIG_INT(ClPeeeekWorldParticlesTexture, cl_peeeek_world_particles_texture, 13, 1, 13, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Texture ID")
MACRO_CONFIG_COL(ClPeeeekWorldParticlesColor, cl_peeeek_world_particles_color, 0xFFFFFFFFU, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Color")
MACRO_CONFIG_INT(ClPeeeekWorldParticlesPhysics, cl_peeeek_world_particles_physics, 2, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Physics (0=Bounce, 1=Wind, 2=Levitation)")
MACRO_CONFIG_INT(ClPeeeekWorldParticlesWindStrength, cl_peeeek_world_particles_wind_strength, 30, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "World Particles Wind Strength")
